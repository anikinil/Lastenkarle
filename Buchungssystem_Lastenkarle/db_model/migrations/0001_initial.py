# Generated by Django 4.2.4 on 2025-01-23 13:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db_model.region')),
                ('store_flag', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='db_model.user_flag')),
            ],
        ),
        migrations.CreateModel(
            name='LocalData',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db_model.store', to_field='name')),
            ],
        ),
        migrations.AddField(
            model_name='user',
            name='user_flags',
            field=models.ManyToManyField(to='db_model.user_flag'),
        ),
    ]
